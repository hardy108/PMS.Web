...
namespace PMS.Web.Services.Controllers.Organization
{
    ...
    [ApiController]
    public class EmployeeChangeController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "EmployeeChange"; //Replace with your own route name


        private AuthenticationServiceEstate _authenticationService;        
        private EmployeeChange _service;
        ...
        public EmployeeChangeController(AuthenticationServiceEstate authenticationService,AuthenticationServiceHO authenticationServiceHO, PMSContextHO context, PMSContextEstate contextEstate,WFContext wfContext,IBackgroundTaskQueue taskQueue,IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _contextEstate = contextEstate;
            _contextHO = context;
            _service = new EmployeeChange(context, wfContext, authenticationServiceHO, taskQueue,emailSender,auditContext);
