...
namespace PMS.Web.Services.Controllers.Location
{
    ...
    {
        private const string _CONTROLLER_NAME = "department";
        private Department _service;
        AuthenticationServiceEstate _authenticationService;

        public DepartmentController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new Department(context, _authenticationService, auditContext);
        }
        ...
        public IActionResult GetList([FromQuery]FilterDepartment param)
        {
        ...
        public IActionResult GetListCount([FromQuery]FilterDepartment param)
        {
        ...
        public IActionResult GetListForSelect([FromQuery]FilterDepartment param)
        {
            return Ok(_service.GetList(param).Select(c => new SelectOptionItem() { Id = c.DEPTID, Text = c.DEPTID + " - " + c.DEPTNAME }));
        }
