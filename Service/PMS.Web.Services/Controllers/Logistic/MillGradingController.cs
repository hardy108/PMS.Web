...
{
    public class MillGradingController : Controller
    {
        private const string _CONTROLLER_NAME = "MillGrading";
        private MillGrading _service;
        AuthenticationServiceEstate _authenticationService;

        public MillGradingController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new MillGrading(context, _authenticationService, auditContext);
        }
