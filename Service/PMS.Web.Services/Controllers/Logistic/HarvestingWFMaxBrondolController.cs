...
namespace PMS.Web.Services.Controllers.Logistic
{
    ...
    [ApiController]
    public class HarvestingWFMaxBrondolController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "HarvestingWFMaxBrondol"; //Replace with your own route name


        private AuthenticationServiceEstate _authenticationService;        
        private HarvestingWFMaxBrondol _service;
        private PMSContextEstate _context;
        


        public HarvestingWFMaxBrondolController(AuthenticationServiceEstate authenticationService, AuthenticationServiceHO authenticationServiceHO, PMSContextEstate context, WFContext wfContext,IBackgroundTaskQueue taskQueue,IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = authenticationService;            
            _context = context;
            _service = new HarvestingWFMaxBrondol(_context, wfContext, _authenticationService,authenticationServiceHO, taskQueue,emailSender,auditContext);
