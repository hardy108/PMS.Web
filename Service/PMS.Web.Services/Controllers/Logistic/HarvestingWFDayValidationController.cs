...
namespace PMS.Web.Services.Controllers.Logistic
{
    ...
    [ApiController]
    public class HarvestingWFDayValidationController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "HarvestingWFDayValidation"; //Replace with your own route name


        private AuthenticationServiceEstate _authenticationService;        
        private HarvestingWFDayValidation _service;        
        private PMSContextEstate _context;
        //private PMS.EFCore.Services.Organization.Employee _employeeService;


        public HarvestingWFDayValidationController(AuthenticationServiceEstate authenticationService, AuthenticationServiceHO authenticationServiceHO, PMSContextEstate context,WFContext wfContext,IBackgroundTaskQueue taskQueue,IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = authenticationService;            
            _context = context;
            _service = new HarvestingWFDayValidation(_context, wfContext, _authenticationService,authenticationServiceHO, taskQueue,emailSender,auditContext);
