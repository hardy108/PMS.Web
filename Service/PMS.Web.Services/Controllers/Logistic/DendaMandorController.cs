...
{
    [ApiController]
    public class DendaMandorController : Controller
    {
        private const string _CONTROLLER_NAME = "dendamandor";
        private DendaMandor _service;
        AuthenticationServiceEstate _authenticationService;

        public DendaMandorController(AuthenticationServiceEstate authenticationService, PMSContextEstate context,AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new DendaMandor(context, _authenticationService,auditContext);
        }
