...
{
    public class SpeksiController : Controller
    {
        private const string _CONTROLLER_NAME = "speksi";
        private Speksi _service;
        AuthenticationServiceEstate _authenticationService;

        public SpeksiController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new Speksi(context, _authenticationService, auditContext);
        }
