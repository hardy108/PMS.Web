...
namespace PMS.Web.Services.Controllers.Logistic
{
    ...
    [ApiController]
    public class HarvestingWFLebihBasisHOController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "HarvestingWFLebihBasisHO"; //Replace with your own route name
        ...
        public HarvestingWFLebihBasisHOController(AuthenticationServiceHO authenticationService,  PMSContextHO context, WFContext wfContext,IBackgroundTaskQueue taskQueue,IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = authenticationService;            
            _context = context;
            _service = new HarvestingWFLebihBasis(_context, wfContext, _authenticationService,_authenticationService, taskQueue,emailSender,auditContext);
