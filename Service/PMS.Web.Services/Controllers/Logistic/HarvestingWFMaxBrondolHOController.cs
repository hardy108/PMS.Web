...
namespace PMS.Web.Services.Controllers.Logistic
{
    ...
    [ApiController]
    public class HarvestingWFMaxBrondolHOController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "HarvestingWFMaxBrondolHO"; //Replace with your own route name
        ...
        public HarvestingWFMaxBrondolHOController(AuthenticationServiceHO authenticationService, PMSContextHO context, WFContext wfContext,IBackgroundTaskQueue taskQueue,IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = authenticationService;            
            _context = context;
            _service = new HarvestingWFMaxBrondol(_context, wfContext, _authenticationService,_authenticationService, taskQueue,emailSender,auditContext);
