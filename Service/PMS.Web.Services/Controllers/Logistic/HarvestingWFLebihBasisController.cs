...
namespace PMS.Web.Services.Controllers.Logistic
{
    ...
    [ApiController]
    public class HarvestingWFLebihBasisController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "HarvestingWFLebihBasis"; //Replace with your own route name


        private AuthenticationServiceEstate _authenticationService;
        private HarvestingWFLebihBasis _service;
        private PMSContextEstate _context;



        public HarvestingWFLebihBasisController(AuthenticationServiceEstate authenticationService, AuthenticationServiceHO authenticationServiceHO, PMSContextEstate context, WFContext wfContext, IBackgroundTaskQueue taskQueue, IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _context = context;
            _service = new HarvestingWFLebihBasis(_context, wfContext, _authenticationService,authenticationServiceHO, taskQueue, emailSender, auditContext);
