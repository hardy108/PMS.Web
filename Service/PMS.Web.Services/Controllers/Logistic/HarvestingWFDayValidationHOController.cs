...
namespace PMS.Web.Services.Controllers.Logistic
{
    ...
    [ApiController]
    public class HarvestingWFDayValidationHOController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "HarvestingWFDayValidationHO"; //Replace with your own route name
        ...
        public HarvestingWFDayValidationHOController(AuthenticationServiceHO authenticationService, PMSContextHO context, WFContext wfContext,IBackgroundTaskQueue taskQueue,IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = authenticationService;            
            _context = context;
            _service = new HarvestingWFDayValidation(context, wfContext, _authenticationService,_authenticationService, taskQueue,emailSender,auditContext);
