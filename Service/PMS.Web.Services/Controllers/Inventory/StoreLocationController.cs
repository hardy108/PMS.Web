...
namespace PMS.Web.Services.Controllers.Inventory
{
    ...
    {
        private const string _CONTROLLER_NAME = "storelocation";
        private StoreLocation _service;
        AuthenticationServiceEstate _authenticationService;

        public StoreLocationController(AuthenticationServiceEstate authenticationService, PMSContextEstate context,AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new StoreLocation(context, _authenticationService, auditContext);
        }
