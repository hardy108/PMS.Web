...
namespace PMS.Web.Services.Controllers.General
{
    ...
    {
        private const string _CONTROLLER_NAME = "vendor";
        private Vendor _service;
        AuthenticationServiceEstate _authenticationService;

        public VendorController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new Vendor(context, _authenticationService,auditContext);
        }
