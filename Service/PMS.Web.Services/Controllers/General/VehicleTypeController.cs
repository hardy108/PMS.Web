...
namespace PMS.Web.Services.Controllers.General
{
    ...
    {
        private const string _CONTROLLER_NAME = "vehicletype";
        private VehicleType _service;
        AuthenticationServiceEstate _authenticationService;

        public VehicleTypeController(AuthenticationServiceEstate authenticationService, PMSContextEstate context,AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new VehicleType(context, _authenticationService,auditContext);
        }
