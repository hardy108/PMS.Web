...
namespace PMS.Web.Services.Controllers.Organization
{
    ...
    [ApiController]
    public class ITIOMController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "itiom"; //Replace with your own route name
        

        private AuthenticationServiceEstate _authenticationService;
        private ITIOM _service;
        
        public ITIOMController(AuthenticationServiceEstate authenticationService,AuthenticationServiceHO authenticationServiceHO,  PMSContextHO context,WFContext wfContext, IBackgroundTaskQueue taskQueue,IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new ITIOM(context,wfContext, authenticationServiceHO, taskQueue,emailSender,auditContext);
        }
