...
namespace PMS.Web.Services.Controllers.Organization
{
    ...
    [ApiController]
    public class ICRController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "icr"; //Replace with your own route name
        

        private AuthenticationServiceEstate _authenticationService;
        private PMSContextHO _context;
        private ICR _service;
        
        public ICRController(AuthenticationServiceEstate tokenService,AuthenticationServiceHO authenticationServiceHO, PMSContextHO context,WFContext wfContext,IBackgroundTaskQueue taskQueue,IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = tokenService;
            _service = new ICR(context,wfContext, authenticationServiceHO, taskQueue,emailSender,auditContext);
            _context = context;
        }
