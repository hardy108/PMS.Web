...
namespace PMS.Web.Services.Controllers.Organization
{
    ...
    [ApiController]
    public class ITInvoiceController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "itinvoice"; //Replace with your own route name
        

        private AuthenticationServiceEstate _authenticationService;
        private ITInvoice _service;
        
        public ITInvoiceController(AuthenticationServiceEstate authenticationService,AuthenticationServiceHO authenticationServiceHO, PMSContextHO context,WFContext wfContext,  IBackgroundTaskQueue taskQueue,IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new ITInvoice(context,wfContext,authenticationServiceHO,taskQueue,emailSender,auditContext);
        }
