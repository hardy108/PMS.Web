...
{
    public class CappingEmployeeController : Controller
    {
        private const string _CONTROLLER_NAME = "cappingemployee";
        private CappingEmployee _service;
        AuthenticationServiceEstate _authenticationService;

        public CappingEmployeeController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new CappingEmployee(context, _authenticationService, auditContext);
        }
