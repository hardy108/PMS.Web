...
namespace PMS.Web.Services.Controllers.Attendances
{
    ...
    {
        private const string _CONTROLLER_NAME = "scheduleemployee"; //Replace with your own route name        
        private ScheduleEmpoyee _service;
        private AuthenticationServiceEstate _authenticationService;

        public ScheduleEmployeeController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new ScheduleEmpoyee(context, _authenticationService, auditContext);
        }

        [HttpGet]
        [Route("api/" + _CONTROLLER_NAME + "/initnew")]
        public IActionResult InitNewRecord()
        {
        ...
        public IActionResult Get([FromRoute]string Id)
        {
            ...
            return Ok(_service.GetSingle(Id, webSession.DecodedToken.UserName));
        }
