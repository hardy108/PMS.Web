...
namespace PMS.Web.Services.Controllers.Attendances
{
    ...
    {
        private const string _CONTROLLER_NAME = "attendance";
        private Attendance _service;
        AuthenticationServiceEstate _authenticationService;

        public AttendanceController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new Attendance(context, _authenticationService, auditContext);
        }
