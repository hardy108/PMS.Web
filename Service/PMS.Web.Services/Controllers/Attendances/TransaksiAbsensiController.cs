...
{
    [ApiController]
    public class TransaksiAbsensiController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "transaksiabsensi";
        private TransaksiAbsensi _service;
        AuthenticationServiceEstate _authenticationService;

        public TransaksiAbsensiController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new TransaksiAbsensi(context,_authenticationService, auditContext);
        }
