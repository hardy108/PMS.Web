...
namespace PMS.Web.Services.Controllers.Organization
{
    ...
    [ApiController]
    public class AttendanceProblemController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "AttendanceProblem"; //Replace with your own route name


        private AuthenticationServiceEstate _authenticationService;        
        private AttendanceProblem _service;
        ...
        public AttendanceProblemController(AuthenticationServiceEstate authenticationService,AuthenticationServiceHO authenticationServiceHO, PMSContextHO context, PMSContextEstate contextEstate,WFContext wfContext,IBackgroundTaskQueue taskQueue,IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _contextEstate = contextEstate;
            _contextHO = context;
            _service = new AttendanceProblem(context, wfContext, authenticationServiceHO, taskQueue,emailSender,auditContext);
