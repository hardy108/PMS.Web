...
{
    [ApiController]
    public class AttendanceGroupController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "attendancegroup";
        private AttendanceGroup _service;
        AuthenticationServiceEstate _authenticationService;

        public AttendanceGroupController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new AttendanceGroup(context, _authenticationService, auditContext);
        }
