...
{
    [ApiController]
    public class PremiOperatorController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "premioperator"; //Replace with your own route name
        private PremiOperator _service;
        private AuthenticationServiceEstate _authenticationService;

        public PremiOperatorController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new PremiOperator(context, _authenticationService, auditContext);
        }
