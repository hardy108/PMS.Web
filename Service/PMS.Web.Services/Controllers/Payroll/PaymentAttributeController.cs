...
{
    [ApiController]
    public class PaymentAttributeController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "PaymentAttributeController"; //Replace with your own route name
        private PaymentAttribute _service;
        private AuthenticationServiceEstate _authenticationService;

        public PaymentAttributeController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new PaymentAttribute(context, _authenticationService, auditContext);
        }
