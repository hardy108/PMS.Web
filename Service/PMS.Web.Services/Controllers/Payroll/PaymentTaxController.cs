...
{
    [ApiController]
    public class PaymentTaxController : Controller
    {
        private const string _CONTROLLER_NAME = "paymenttax";
        private PaymentTax _service;
        AuthenticationServiceEstate _authenticationService;

        public PaymentTaxController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new PaymentTax(context, _authenticationService, auditContext);
        }
