...
{
    [ApiController]
    public class PaymentSchemeController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "PaymentScheme";
        private PaymentScheme _service;
        private AuthenticationServiceEstate _authenticationService;

        public PaymentSchemeController(AuthenticationServiceEstate authenticationService, PMSContextEstate context,AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new PaymentScheme(context, _authenticationService,auditContext);
        }
