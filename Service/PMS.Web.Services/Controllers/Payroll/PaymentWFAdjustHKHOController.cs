...
namespace PMS.Web.Services.Controllers.Logistic
{
    ...
    [ApiController]
    public class PaymentWFAdjustHKHOController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "PaymentWFAdjustHKHO"; //Replace with your own route name
        ...
        public PaymentWFAdjustHKHOController(AuthenticationServiceHO authenticationService, PMSContextHO context,WFContext wfContext,IBackgroundTaskQueue taskQueue,IEmailSender emailSender, AuditContext auditContext)
        {
            _authenticationService = authenticationService;            
            _context = context;
            _service = new PaymentWFAdjustHK(_context, wfContext, _authenticationService,_authenticationService, taskQueue,emailSender,auditContext);
