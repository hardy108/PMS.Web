...
namespace PMS.Web.Services.Controllers.Payroll
{
    ...
    {
        private const string _CONTROLLER_NAME = "paymentdetail";
        private PaymentDetail _service;
        AuthenticationServiceEstate _authenticationService;

        public PaymentDetailController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new PaymentDetail(context, _authenticationService, auditContext);
        }
