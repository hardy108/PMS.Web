...
namespace PMS.Web.Services.Controllers.Payroll
{
    ...
    {
        private const string _CONTROLLER_NAME = "salaryitem";
        private SalaryItem _service;
        AuthenticationServiceEstate _authenticationService;

        public SalaryItemController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new SalaryItem(context, _authenticationService, auditContext);
        }
