...
{
    [ApiController]
    public class PremiMandor1Controller : ControllerBase
    {
        private const string _CONTROLLER_NAME = "PremiMandor1"; //Replace with your own route name
        private PremiMandor1 _service;
        private AuthenticationServiceEstate _authenticationService;

        public PremiMandor1Controller(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new PremiMandor1(context, _authenticationService, auditContext);
        }
