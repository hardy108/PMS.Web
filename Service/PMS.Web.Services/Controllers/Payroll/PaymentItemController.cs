...
namespace PMS.Web.Services.Controllers.Payroll
{
    ...
    {
        private const string _CONTROLLER_NAME = "paymentitem";
        private PaymentItem _service;
        AuthenticationServiceEstate _authenticationService;

        public PaymentItemController(AuthenticationServiceEstate authenticationService, PMSContextEstate context,AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new PaymentItem(context, _authenticationService,auditContext);
        }
