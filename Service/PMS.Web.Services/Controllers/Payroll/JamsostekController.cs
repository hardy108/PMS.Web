...
{
    [ApiController]
    public class JamsostekController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "Jamsostek";
        private Jamsostek _service;
        private AuthenticationServiceEstate _authenticationService;

        public JamsostekController(AuthenticationServiceEstate authenticationService, PMSContextEstate context,AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new Jamsostek(context, _authenticationService,auditContext);
        }
