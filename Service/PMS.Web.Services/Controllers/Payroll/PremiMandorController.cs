...
{
    [ApiController]
    public class PremiMandorController : ControllerBase
    {
        private const string _CONTROLLER_NAME = "PremiMandor"; //Replace with your own route name
        private PremiMandor _service;
        private AuthenticationServiceEstate _authenticationService;

        public PremiMandorController(AuthenticationServiceEstate authenticationService, PMSContextEstate context, AuditContext auditContext)
        {
            _authenticationService = authenticationService;
            _service = new PremiMandor(context, _authenticationService, auditContext);
        }
