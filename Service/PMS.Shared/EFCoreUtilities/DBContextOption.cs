...
namespace PMS.Shared.EFCoreUtilities
{
    ...
    public class DBContextOption        
    {
        ...
        //    return SqlServerDbContextOptionsExtensions.UseSqlServer(new DbContextOptionsBuilder<T>(), GetConnectionStringByName(connectionName, encryptionKey)).Options;
        //}
        public static DbContextOptions GetOptions(string connectionString, string encryptionKey)
        {
            return SqlServerDbContextOptionsExtensions.UseSqlServer(new DbContextOptionsBuilder(), GetConnectionString(connectionString, encryptionKey)).Options;
        }

        public static DbContextOptions GetOptions(string dbSource, string dbName, string userId, string password, string encryptionKey)
        {
