...
namespace PMS.Shared.Utilities
{
    ...
    public static class ObjectExtensions
    {
        ...
        public static PropertyInfo GetProperty<T>(this T entity, string name)
        {
        ...
        public static string ToCSV(this IEnumerable query, string replacementDelimiter)
        {

            return query.AsQueryable().ToCSV(replacementDelimiter);
        }

        public static string ToCSV(this IQueryable query, string replacementDelimiter)
        {
