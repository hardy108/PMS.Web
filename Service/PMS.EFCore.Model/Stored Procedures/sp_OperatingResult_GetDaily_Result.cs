...
{
    public class sp_OperatingResult_GetDaily_Result
    {
        ...
        public int FRIDAYPERCENT { get; set; }
    ...
    {
        public IEnumerable<sp_OperatingResult_GetDaily_Result> sp_OperatingResult_GetDaily_Result(string divId, DateTime date)
        {
            IEnumerable<sp_OperatingResult_GetDaily_Result> rows = null;
            this.LoadStoredProc("sp_OperatingResult_GetDaily")
                .AddParam("Divid", divId)
                .AddParam("Date", date)
                .Exec(r => rows = r.ToList<sp_OperatingResult_GetDaily_Result>());
            return rows;
        }

        public IEnumerable<TOPERATINGRESULT> sp_TOPERATINGRESULT_GetDaily_Result(string divId, DateTime date)
        {
            IEnumerable<sp_OperatingResult_GetDaily_Result> rows = null;
            IEnumerable<TOPERATINGRESULT> rowsx = null;
            ...
            rowsx = rows.Select(s => new TOPERATINGRESULT
            {
