...
{
    public class sp_HarvestingResult_GetGerdanFromHarvestingCollection_Result
    {
        ...
        public int FINEQTY { get; set; }
        public int FINEAMOUNT { get; set; }
        public int PREMIPKKTGI { get; set; }
        ...
        public int HAHASIL { get; set; }
        public int HABASE { get; set; }
        public int HAPREMI { get; set; }
    ...
    {
        public IEnumerable<sp_HarvestingResult_GetGerdanFromHarvestingCollection_Result> sp_HarvestingResult_GetGerdanFromHarvestingCollection_Result
            (string unitCode, DateTime startdate, DateTime endDate, bool basisByKg)
        {
            IEnumerable<sp_HarvestingResult_GetGerdanFromHarvestingCollection_Result> rows = null;
            this.LoadStoredProc("sp_HarvestingResult_GetGerdanFromHarvestingCollection")
                .AddParam("StartDate", startdate)
                .AddParam("EndDate", endDate)
                .AddParam("UnitCode", unitCode)
                .AddParam("BasisByKg", basisByKg)
                .Exec(r => rows = r.ToList<sp_HarvestingResult_GetGerdanFromHarvestingCollection_Result>());
            return rows;
        }
    }
