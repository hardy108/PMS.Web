...
{
    public class sp_HarvestingResult_GetGerdanDaily_Result
    {
    ...
    {
        public IEnumerable<sp_HarvestingResult_GetGerdanDaily_Result> sp_HarvestingResult_GetGerdanDaily(string divId, DateTime date)
        {
            IEnumerable<sp_HarvestingResult_GetGerdanDaily_Result> rows = null;
            this.LoadStoredProc("sp_HarvestingResult_GetGerdanDaily")
                .AddParam("Divid", divId)
                .AddParam("Date", date)
                .Exec(r => rows = r.ToList<sp_HarvestingResult_GetGerdanDaily_Result>());
            return rows;
        }

        public IEnumerable<VTHARVESTRESULT1> sp_VTHARVESTRESULT1GetGerdanDaily(string divId, DateTime date)
        {
            IEnumerable<sp_HarvestingResult_GetGerdanDaily_Result> rows = null;
