...
{
    public class fn_DHS_Doket_GetById_Result
    {
        ...
        public string DOK_STATUS_TEXT { get; set; }
        public string DOK_MANDORNAME { get; set; }
        public string DOK_KERANINAME { get; set; }
        public string DOK_PEMANENNAME { get; set; }
        public string DOK_PEMBRONDOLNAME { get; set; }
        public string DOK_CHECKERNAME { get; set; }
    }
